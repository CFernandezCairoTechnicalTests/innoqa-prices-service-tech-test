...
INSERT INTO `brands_1` (`id`, `name`) VALUES
(1, 'ZARA');
...
--
-- Table structure for table `prices_1`
--
...
INSERT INTO `prices_1` (`id`, `end_date`, `curr`, `price`, `price_list`, `priority`, `product_id`, `start_date`, `brand_id`) VALUES
...
--
-- Table structure for table `brands_2`
--

CREATE TABLE `brands_2` (
  `id` bigint NOT NULL,
  `name` varchar(255) NOT NULL
);

--
-- Dumping data for table `brands_2`
--
