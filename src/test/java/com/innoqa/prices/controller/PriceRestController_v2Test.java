...
class PriceRestController_v2Test {
    ...
    private static final Logger logger = LoggerFactory.getLogger(PriceRestController_v2Test.class);
    ...
    @DisplayName(value = "INNOQA TECH-TEST Controller v2")
    void testinnoqaTechTest_v2(Long brandID, Long productID, String applyDate, Object expectedPrice) throws Exception {
        ...
        mockMvc.perform(get(PriceController_v2.INNOQA_TECH_TEST_v2_RESOURCE + "/techtest").queryParams(currentParams))
